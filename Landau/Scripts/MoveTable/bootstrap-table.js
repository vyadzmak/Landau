...
!function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.search) {
            html = [];
            html.push(
                '<div class="pull-' + this.options.searchAlign + ' search" style=\"position: fixed; margin-right: 10px; background-color: white;' +
                ' z-index: 5000; margin-left: 60%; margin-top: -50px\">',
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        if (!this.$body.length) {
            this.$body = $('<tbody style=\"max-height: 20%; height: 500px; overflow-y: scroll;\"></tbody>').appendTo(this.$el);
        }
